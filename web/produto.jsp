                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level collapse in">
                                <li>
                                    <a class="active" href="BuscaClientesProdutos"><i class=" fa-fw"></i> Efetuar Venda</a>
                                </li>
                                <li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="">
                        <i class=""></i> <a href="BuscaClientesProdutos">Efetuar Venda</a>
                    </li>
                    <li class="active">
                        <i class=""> </i> <a href="BuscaClientesProdutos"> Selecionar Cliente</a>
                    </li>
                    <li class="active">
                        <i class=""></i> Selecionar Produto
                    </li>
