 ...
 * @author Caah
 */
public class BuscaClienteCNPJ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BuscaClienteCNPJ</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BuscaClienteCNPJ at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            /*tira os traços e pontos do cnpj*/
            ...
            /*Faz a busca*/
            cliente = clientesDAO.buscaNomePorCNPJ(cnpjAux);
            
            PrintWriter writer = response.getWriter();
            if (cliente != null) {
                writer.print(cliente.getNome() + ";" + cnpj);
            } else {
                writer.print("null");
            }
