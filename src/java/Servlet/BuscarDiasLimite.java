...
import Servlet.BuscaClientesProdutos;
 ...
 * @author Caah
 */
public class BuscarDiasLimite extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BuscarDataLimite</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BuscarDataLimite at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int codProduto, diasLimite;
         ...
         try {
            ...
            diasLimite = produtosDAO.buscaDiasLimite(codProduto);
            
            /*Manda de volta pra aplicação*/
            PrintWriter writer = response.getWriter();
            writer.print(diasLimite);
            writer.close();        
